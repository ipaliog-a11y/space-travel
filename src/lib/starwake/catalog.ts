...
export const MODULES: Record<string, ModuleDef> = {
  ...
  "n-drv-haul": { id: "n-drv-haul", slot: "drive", hull: "tender", name: "Deep Sip", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 0.6, overdriveSpeed: -4, overdriveSec: 3 } },
  "n-drv-kick": { id: "n-drv-kick", slot: "drive", hull: "tender", name: "Kick Cell", blurb: "Punchier OD. Less cruise.", delta: { cruiseSpeed: -0.6, overdriveSpeed: 8, overdriveSec: -3, mass: 0.08 } },
  ...
  "g-drv-sprint": { id: "g-drv-sprint", slot: "drive", hull: "tug", name: "Kick Coil", blurb: "Hot OD. Shorter cruise.", delta: { cruiseSpeed: -0.7, overdriveSpeed: 8, overdriveSec: -2, mass: 0.06 } },
  "g-drv-cruise": { id: "g-drv-cruise", slot: "drive", hull: "tug", name: "Lane Tube", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 0.9, overdriveSpeed: -6, overdriveSec: 2 } },
