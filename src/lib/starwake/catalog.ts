...
export const SHIPS: Record<ShipId, ShipDef> = {
  ...
  tender: {
    ...
    name: "Tender",
    role: "Fuel",
    blurb: "Cryo spheres. Fat T1. The bay that never runs dry.",
    detail: "Orbital tanker — depot hull with two cryo spheres and a collar. NASA-style propellant mule: you carry the reaction mass so the line ships can keep flying. Lazy stick, long sips.",
    mass: 1.55,
    turnRate: 0.72,
    cruiseSpeed: 9.2,
    overdriveSpeed: 64,
  ...
  tug: {
    ...
    name: "Tug",
    role: "Harbor",
    blurb: "Short legs. Hard RCS. Built to shove a lock.",
    detail: "Orbital transfer vehicle — box hull, folded arms, docking ring. Moves crates between bays in one system. Points like a tool. You will not cross the arm without a friend.",
    mass: 1.05,
    turnRate: 1.58,
    cruiseSpeed: 10.0,
    overdriveSpeed: 84,
...
export const MODULES: Record<string, ModuleDef> = {
  ...
  "c-drv-sprint": { id: "c-drv-sprint", slot: "drive", hull: "courier", name: "Sprint Coil", blurb: "Hot OD. Shorter cruise.", delta: { cruiseSpeed: -2.4, overdriveSpeed: 36, overdriveSec: -4, mass: 0.1 } },
  "c-drv-cruise": { id: "c-drv-cruise", slot: "drive", hull: "courier", name: "Cruise Tube", blurb: "Longer band. Softer OD.", delta: { cruiseSpeed: 3.2, overdriveSpeed: -24, overdriveSec: 4 } },
  ...
  "h-drv-haul": { id: "h-drv-haul", slot: "drive", hull: "hauler", name: "Deep Haul", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 1.6, overdriveSpeed: -12, overdriveSec: 3 } },
  "h-drv-kick": { id: "h-drv-kick", slot: "drive", hull: "hauler", name: "Kick Coil", blurb: "Punchier OD. Less cruise.", delta: { cruiseSpeed: -1.6, overdriveSpeed: 20, overdriveSec: -3, mass: 0.08 } },
  ...
  "h-hld-deep": { id: "h-hld-deep", slot: "hold", hull: "hauler", name: "Deep Hold", blurb: "Fat bay. Costs turn and cruise.", delta: { cargoCap: 24, mass: 0.2, turnRate: -0.1, cruiseSpeed: -0.8 } },
  ...
  "s-drv-sprint": { id: "s-drv-sprint", slot: "drive", hull: "scout", name: "Skip Coil", blurb: "Hot OD. Shorter cruise.", delta: { cruiseSpeed: -1.6, overdriveSpeed: 20, overdriveSec: -3, mass: 0.06 } },
  "s-drv-cruise": { id: "s-drv-cruise", slot: "drive", hull: "scout", name: "Long Tube", blurb: "Softer OD. Longer band.", delta: { cruiseSpeed: 2.4, overdriveSpeed: -16, overdriveSec: 3 } },
  ...
  "k-drv-sprint": { id: "k-drv-sprint", slot: "drive", hull: "clipper", name: "Flare Coil", blurb: "Hotter OD. Shorter cruise.", delta: { cruiseSpeed: -2.0, overdriveSpeed: 24, overdriveSec: -2, mass: 0.08 } },
  "k-drv-cruise": { id: "k-drv-cruise", slot: "drive", hull: "clipper", name: "Lane Tube", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 2.8, overdriveSpeed: -20, overdriveSec: 3 } },
  ...
  "n-thr-stock": { id: "n-thr-stock", slot: "thruster", hull: "tender", name: "Slow Ring", blurb: "Stock mass gimbals.", stock: true, delta: {} },
  "n-thr-dock": { id: "n-thr-dock", slot: "thruster", hull: "tender", name: "Collar Assist", blurb: "Turns the mule. Costs mass.", delta: { turnRate: 0.22, mass: 0.1 } },
  "n-thr-bulk": { id: "n-thr-bulk", slot: "thruster", hull: "tender", name: "Lazy Gimbal", blurb: "Heavier. Softer stick.", delta: { turnRate: -0.14, mass: -0.06 } },
  "n-drv-stock": { id: "n-drv-stock", slot: "drive", hull: "tender", name: "Sip Pulse", blurb: "Stock depot drive.", stock: true, delta: {} },
  "n-drv-haul": { id: "n-drv-haul", slot: "drive", hull: "tender", name: "Deep Sip", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 1.2, overdriveSpeed: -8, overdriveSec: 3 } },
  "n-drv-kick": { id: "n-drv-kick", slot: "drive", hull: "tender", name: "Kick Cell", blurb: "Punchier OD. Less cruise.", delta: { cruiseSpeed: -1.2, overdriveSpeed: 16, overdriveSec: -3, mass: 0.08 } },
  "n-fsd-stock": { id: "n-fsd-stock", slot: "fsd", hull: "tender", name: "Depot Spool", blurb: "Stock mid legs.", stock: true, delta: {} },
  "n-fsd-deep": { id: "n-fsd-deep", slot: "fsd", hull: "tender", name: "Far Cell", blurb: "Further. Slower to wake.", delta: { jumpRangeLy: 5, fsdChargeSec: 1.2 } },
  "n-fsd-port": { id: "n-fsd-port", slot: "fsd", hull: "tender", name: "Port Spool", blurb: "Faster lock. Shorter hop.", delta: { jumpRangeLy: -3, fsdChargeSec: -0.8 } },
  ...
  "g-thr-stock": { id: "g-thr-stock", slot: "thruster", hull: "tug", name: "Shove Ring", blurb: "Stock harbor gimbals.", stock: true, delta: {} },
  "g-thr-bite": { id: "g-thr-bite", slot: "thruster", hull: "tug", name: "Hard Shove", blurb: "Turns harder. Costs mass.", delta: { turnRate: 0.24, mass: 0.07 } },
  "g-thr-soft": { id: "g-thr-soft", slot: "thruster", hull: "tug", name: "Soft Ring", blurb: "Lazier. Lighter ring.", delta: { turnRate: -0.2, mass: -0.05 } },
  "g-drv-stock": { id: "g-drv-stock", slot: "drive", hull: "tug", name: "Bay Pulse", blurb: "Stock harbor drive.", stock: true, delta: {} },
  "g-drv-sprint": { id: "g-drv-sprint", slot: "drive", hull: "tug", name: "Kick Coil", blurb: "Hot OD. Shorter cruise.", delta: { cruiseSpeed: -1.4, overdriveSpeed: 16, overdriveSec: -2, mass: 0.06 } },
  "g-drv-cruise": { id: "g-drv-cruise", slot: "drive", hull: "tug", name: "Lane Tube", blurb: "More cruise. Tamer OD.", delta: { cruiseSpeed: 1.8, overdriveSpeed: -12, overdriveSec: 2 } },
  "g-fsd-stock": { id: "g-fsd-stock", slot: "fsd", hull: "tug", name: "Short Spool", blurb: "Stock short legs.", stock: true, delta: {} },
  "g-fsd-far": { id: "g-fsd-far", slot: "fsd", hull: "tug", name: "Stretch", blurb: "A little further. Slower lock.", delta: { jumpRangeLy: 3, fsdChargeSec: 0.8 } },
  "g-fsd-quick": { id: "g-fsd-quick", slot: "fsd", hull: "tug", name: "Instant", blurb: "Snaps. Shorter hop.", delta: { jumpRangeLy: -2, fsdChargeSec: -0.4 } },
