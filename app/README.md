...
- Kepler galaxy, planet types, moons (scenery — no look / arrive / jump), belts, comets, nebulae
- Two hangar sets: **Line** (Courier / Hauler / Scout / Clipper) and **Yard** (Tender tanker / Tug harbor)
- Hangar selector with avatars, roles, and a short dossier
- Loadouts, T1 fuel, jobs, surveys
...
Hull sets (Line + Yard): [`../docs/HULL_SET.md`](../docs/HULL_SET.md).
